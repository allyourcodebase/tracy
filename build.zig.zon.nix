...
in
  linkFarm name [
    {
      name = "N-V-__8AANcDbQBvyW8WwYNURLcJ8gcE2S5jYJjnOgTqHPaw";
      path = fetchZigArtifact {
        name = "imgui";
        url = "git+https://github.com/ocornut/imgui.git?ref=v1.91.0-docking#139e99ca37a3e127c87690202faec005cd892d36";
        hash = "sha256-A5nd8qEC6pARJtbuU9MDWao+tuVjghx4y+Ed3aqbt/Y=";
        rev = "139e99ca37a3e127c87690202faec005cd892d36";
      };
    }
    {
